...
#
./gradlew violationCommentsToGitLab -DGITLAB_URL=https://gitlab.com/ -DGITLAB_MERGEREQUESTID=1 -DGITLAB_PROJECTID=2732496 -DGITLAB_APITOKEN=$GITLAB_APITOKEN -i --stacktrace
