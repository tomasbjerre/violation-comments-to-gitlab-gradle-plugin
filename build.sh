...
#
./gradlew violationCommentsToGitLab -DGITLAB_URL=https://gitlab.com/ -DGITLAB_MERGEREQUESTIID=1 -DGITLAB_PROJECTID=tomas.bjerre85/violations-test -DGITLAB_APITOKEN=$GITLAB_APITOKEN -i --stacktrace
